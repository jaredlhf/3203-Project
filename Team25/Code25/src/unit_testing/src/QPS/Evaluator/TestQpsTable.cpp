...
TEST_CASE("QpsTable factory method with header and data args returns the right "
          "output") {
  std::vector<std::string> headers({"x", "s1"});
  std::vector<std::string> expectedHeaders({"x", "s1"});
...
TEST_CASE("QpsTable getColResults (with int arg) function returns right values "
          "with arg that is in range") {
  std::vector<std::string> headers({"x", "s1"});
...
TEST_CASE("QpsTable getColResults (with int arg) function returns empty set "
          "with arg that is below range") {
  std::vector<std::string> headers({"x", "s1"});
  std::vector<std::string> row1({"v", "1"});
  std::vector<std::string> row2({"v", "1"});
  std::vector<std::string> row3({"3", "4"});
...
TEST_CASE("QpsTable getColResults (with string arg) function returns results "
          "for header that exists") {
  std::vector<std::string> headers({"x", "s1"});
  std::vector<std::string> row1({"v", "1"});
  std::vector<std::string> row2({"v", "1"});
  std::vector<std::string> row3({"3", "4"});
...
TEST_CASE("QpsTable getColResults (with string arg) function returns empty set "
          "for header that doesnt exist") {
  std::vector<std::string> headers({"x", "s1"});
  std::vector<std::string> row1({"v", "1"});
  std::vector<std::string> row2({"v", "1"});
  std::vector<std::string> row3({"3", "4"});
...
TEST_CASE("QpsTable hasOverlappingHeaders function returns true for other "
          "table with 1 same value") {
...
TEST_CASE("QpsTable getCommonHeaderIndices function returns the right values "
          "for headers with common values") {
...
TEST_CASE("QpsTable getUniqueHeaders function returns the right values for "
          "some overlapping headers in right order") {
...
TEST_CASE("QpsTable getUniqueHeaders function returns the right values for all "
          "overlapping headers in right order") {
  std::vector<std::string> headers1({"x", "y", "z"});
...
TEST_CASE("QpsTable getUniqueHeaders function returns the right values for no "
          "overlapping headers in right order") {
  std::vector<std::string> headers1({"x", "y", "z"});
...
TEST_CASE("QpsTable canMergeInnerJoinRows function returns true for rows that "
          "can join") {
...
TEST_CASE("QpsTable canMergeInnerJoinRows function returns false for rows that "
          "cant join") {
  std::vector<std::string> row1({"w", "x", "y", "z"});
  std::vector<std::string> row2({"x", "b", "w", "z"});
  std::vector<std::string> header1({"1", "2", "3", "4"});
...
TEST_CASE(
    "QpsTable innerJoin function returns right result for 1 common header") {
  ...
  std::set<std::vector<std::string>> resData =
      table1->innerJoin(table2)->getData();

  REQUIRE(resData == expectedData);
}

TEST_CASE(
    "QpsTable innerJoin function returns right result for 2 common headers") {
  std::vector<std::string> t1row1({"x", "y", "z"});
  std::vector<std::string> t1row2({"p", "q", "r"});
  ...
  std::set<std::vector<std::string>> t2Data(
      {t2row1, t2row2, t2row3, t2row4, t2row5});
  ...
  std::set<std::vector<std::string>> expectedData({expectedRow1, expectedRow2,
                                                   expectedRow3, expectedRow4,
                                                   expectedRow5, expectedRow6});
...
TEST_CASE("QpsTable innerJoin function returns right result for 2 common "
          "headers with same num of rows") {
...
TEST_CASE(
    "QpsTable join function returns right result for 1 empty table as arg") {
  std::vector<std::string> t1row1({"1", "2"});
  std::vector<std::string> t1row2({"1", "3"});
  std::vector<std::string> t1row3({"4", "2"});
  std::vector<std::string> t1row4({"5", "3"});
...
TEST_CASE(
    "QpsTable join function returns right result for 1 empty table as caller") {
  std::vector<std::string> t1row1({"1", "2"});
  std::vector<std::string> t1row2({"1", "3"});
  std::vector<std::string> t1row3({"4", "2"});
  std::vector<std::string> t1row4({"5", "3"});
...
TEST_CASE("QpsTable join function returns right result for no common headers "
          "(cross product)") {
  std::vector<std::string> headers1({"x", "s1"});
  std::vector<std::string> headers2({"1", "vv"});
  std::vector<std::string> expectedHeader({"x", "s1", "1", "vv"});
...
TEST_CASE("QpsTable join function returns right result for tables with common "
          "headers (inner join)") {
  std::vector<std::string> t1row1({"x", "y", "z"});
  std::vector<std::string> t1row2({"p", "q", "r"});
  std::vector<std::string> t1row3({"1", "2", "3"});
