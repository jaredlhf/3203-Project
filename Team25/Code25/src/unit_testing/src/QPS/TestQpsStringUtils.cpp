...
TEST_CASE(
    "isValidInt Alphabetic string with negative sign should return false") {
  std::string testInput = "-abc";
  REQUIRE(StringUtils::isValidInt(testInput) == false);
}

TEST_CASE(
    "isValidInt Alphabetic string with digits as prefix should return false") {
  std::string testInput = "123c";
  REQUIRE(StringUtils::isValidInt(testInput) == false);
}

TEST_CASE("isValidInt Digits with negative sign at non first char should "
          "return false") {
  std::string testInput = "123-";
  REQUIRE(StringUtils::isValidInt(testInput) == false);
}
...
TEST_CASE(
    "spaceifyString String with a simple expression returns the right result") {
  std::string test = "1+2";
  std::string expected = "1 + 2";
  REQUIRE(StringUtils::spaceifyString(test) == expected);
}

TEST_CASE("spaceifyString String with a complex expression returns the right "
          "result") {
...
TEST_CASE("spaceifyString String with a complex expression with multichar "
          "tokens returns the right result") {
...
TEST_CASE(
    "splitString String with a normal string token returns list of itself") {
  std::string test = "main";
...
TEST_CASE(
    "splitString String with a simple expression returns the right result") {
  std::string test = "1 + 2";
...
TEST_CASE(
    "splitString String with a complex expression returns the right result") {
  std::string test = "x +  ( z * y1 )  + 1";
...
TEST_CASE("splitString String with a complex expression with multichar tokens "
          "returns the right result") {
  std::string test = "xyz +  ( z1w * y1 )  + 12";
  std::vector<std::string> expected = {"xyz", "+", "(", "z1w", "*",
                                       "y1",  ")", "+", "12"};
  REQUIRE(StringUtils::splitString(test) == expected);
}
...
TEST_CASE("tokenInOp String with a normal string as a substr of another string "
          "return false") {
  std::string op = "main";
...
TEST_CASE("tokenInOp String with a normal string as a substr of another space "
          "separated string return true") {
  std::string op = "main";
  std::string token = "main program";
  REQUIRE(StringUtils::tokenInOp(op, token) == false);
}

TEST_CASE("tokenInOp String with a int in a simple expression returns the "
          "right result") {
  std::string op = "12+2";
  std::string token = "12";
  REQUIRE(StringUtils::tokenInOp(op, token) == true);
...
TEST_CASE("tokenInOp String with a strtoken in a simple expression returns the "
          "right result") {
...
TEST_CASE("tokenInOp String with a substr of strtoken in a simple expression "
          "returns the right result") {
  std::string op = "12+send2";
  std::string token = "2";
  REQUIRE(StringUtils::tokenInOp(op, token) == false);
...
TEST_CASE("tokenInOp String with int in a complex expression returns the right "
          "result") {
...
TEST_CASE("tokenInOp String with substr of int in a complex expression returns "
          "the right result") {
  std::string op = "x+(z*y1)+100";
  std::string token = "10";
  REQUIRE(StringUtils::tokenInOp(op, token) == false);
...
TEST_CASE("tokenInOp String with a str token in complex expression returns the "
          "right result") {
...
TEST_CASE("tokenInOp String with a substr of str token in complex expression "
          "returns the right result") {
  std::string op = "xyz+(z1w*y1)+12";
  std::string token = "z1";
  REQUIRE(StringUtils::tokenInOp(op, token) == false);
...
TEST_CASE("createPostFixNotation String infix expression with '+' arithmetic "
          "operations") {
...
TEST_CASE("createPostFixNotation String infix expression with '+', '-' "
...
TEST_CASE("createPostFixNotation String infix expression with '+', '-' and "
          "brackets arithmetic operations") {
  std::string infix = "a-(b+c)";
  std::string postfix = "(a)(b)(c)+-";
  std::string result = StringUtils::createPostFixNotation(infix);
  REQUIRE(result == postfix);
...
TEST_CASE("createPostFixNotation String infix expression with '+' and brackets "
          "arithmetic operations") {
  std::string infix = "(a+b)+c";
  std::string postfix = "(a)(b)+(c)+";
  std::string result = StringUtils::createPostFixNotation(infix);
...
TEST_CASE("createPostFixNotation String infix expression with '+', '-', '*' "
          "and brackets arithmetic operations") {
  std::string infix1 = "(a+b)*c-d";
  std::string postfix1 = "(a)(b)+(c)*(d)-";
  std::string result1 = StringUtils::createPostFixNotation(infix1);
  REQUIRE(result1 == postfix1);
...
TEST_CASE("createPostFixNotation String infix expression with '+' and tab "
          "spacing arithmetic operations") {
  std::string infix = "x	";
...
TEST_CASE("createPostFixNotation String infix expression with multi-char "
...
TEST_CASE("createPostFixNotation String infix expression with multi-char "
          "variables, nested brackets and multiple operators") {
...
TEST_CASE("postFixInFullpostFix String full same variables and same ops "
          "postfix successful expression match") {
  std::string postfix = "(a)(b)+";
  std::string fullPostFix = "(a)(b)+";
  REQUIRE(StringUtils::postFixInFullpostFix(postfix, fullPostFix) == true);
}

TEST_CASE("postFixInFullpostFix String full same variable different ops '+', "
          "'-' postfix fail expression match") {
  std::string postfix = "(a)(b)+";
  std::string fullPostFix = "(a)(b)-";
  REQUIRE(StringUtils::postFixInFullpostFix(postfix, fullPostFix) == false);
}

TEST_CASE("postFixInFullpostFix String full postfix same variable, same ops, "
          "different ordering fail expression match") {
  std::string postfix = "(a)(b)+";
  std::string fullPostFix = "(b)(a)+";
  REQUIRE(StringUtils::postFixInFullpostFix(postfix, fullPostFix) == false);
}

TEST_CASE("postFixInFullpostFix String full postfix same multi-char variable, "
          "same ops postfix successful expression match") {
  std::string postfix = "(ghi)(jkl)+";
  std::string fullPostFix = "(def)(ghi)(jkl)+(mnop)(64)-+*";
  REQUIRE(StringUtils::postFixInFullpostFix(postfix, fullPostFix) == true);
}

TEST_CASE("postFixInFullpostFix String partial postfix same variable and same "
          "ops successful expression match") {
