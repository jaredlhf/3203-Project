...
SCENARIO("Mocking behavior of QPS") {
  GIVEN("An instance of the PKB retriever class") {
    ...
    PkbRetriever pkbRet(vsPointer, csPointer, fsPointer, psPointer, ssPointer,
                        ...
                        usesPointer, callsPointer, cStarsPointer, printAPointer,
    ...
    WHEN("The qps object is created") {
      ...
      THEN("For a given multi select query string and population of the "
           "pkbRetriever") {
        list<string> expected = {
            "1 x x", "1 x y", "1 x z", "1 y x", "1 y y", "1 y z", "1 z x",
            "1 z y", "1 z z", "2 x x", "2 x y", "2 x z", "2 y x", "2 y y",
            "2 y z", "2 z x", "2 z y", "2 z z", "3 x x", "3 x y", "3 x z",
            "3 y x", "3 y y", "3 y z", "3 z x", "3 z y", "3 z z"};
        list<string> res;
      ...
      THEN("For a given multi select query string with repeated select and "
           "population of the pkbRetriever") {
        list<string> expected = {"1 x x x", "1 y y y", "1 z z z",
                                 "2 x x x", "2 y y y", "2 z z z",
                                 "3 x x x", "3 y y y", "3 z z z"};
        list<string> res;
  ...
  GIVEN("An instance of the PKB retriever class") {
    ...
    WHEN("The qps object is created") {
      ...
      THEN("For procedure constant uses query, the right result is returned") {
        ...
        string query =
            "variable p1; Select p1 such that Uses(\"factorial\", p1)";
      ...
      THEN("For modifies query in the form (s1, 'y') with procedure, the right "
           "result is returned") {
      ...
      THEN("For procedure constant modifies query in the form (s1, 'y'), the "
           "right result is returned") {
        list<string> expected = {"w", "x", "y", "z"};
        list<string> res;

        string query =
            "variable p1; Select p1 such that Modifies(\"beta\", \"z\")";
      ...
      THEN("For calls query in the form ('beta', s1), the right result is "
           "returned") {
        list<string> expected = {"factorial", "main"};
        list<string> res;
      ...
      THEN("For calls* query in the form (_, s1), the right result is "
           "returned") {
      ...
      THEN("For pattern query in the form (_, 'x'), the right result is "
           "returned") {
      ...
      THEN("For pattern query in the form (_, 'x') with tab spaces, the right "
           "result is returned") {
        list<string> expected = {"3", "7", "9"};
        list<string> res;

        string query =
            "assign a1; stmt s2; Select a1 pattern a1 (_, _\"x\t\t\t\"_)";
      ...
      THEN("For pattern query in the form (v1, _'y'_), the right result is "
        ...
        string query =
            "assign a1; variable v1; Select v1 pattern a1 (v1, _\"y\"_)";
      ...
      THEN("For pattern query in the form ('x', _'y'_), the right result is "
        ...
        string query =
            "assign a1; variable v1; Select a1 pattern a1 (\"x\", _\"y\"_)";
      ...
      THEN("For pattern query with var syn in pattern clause, the right result "
        ...
        string query =
            "assign a1; variable v1; Select a1 pattern a1 (v1, _\"x\"_)";
      ...
      THEN("For combined query with clauses order swapped, the right result is "
           "returned") {
        list<string> expected = {"w", "x"};
        list<string> res;

        string query = "assign a1; variable v1; Select v1 pattern a1 (v1, _) "
                       "such that Parent(2,3)";
      ...
      THEN("For combined query with 1 overlapping synonym, the right result is "
        ...
        string query = "assign a1; variable v1; stmt s1; Select v1 such that "
                       "Uses(a1,v1) pattern a1 (_,_\"y\"_) ";

        qps.query(query, res);
        REQUIRE(res == expected);
      }

      THEN("For combined query with 1 overlapping synonym multiselect, the "
           "right result is returned") {
        list<string> expected = {"1 y", "2 y", "3 y", "4 y", "5 y",
                                 "6 y", "7 y", "8 y", "9 y"};
        list<string> res;

        string query = "assign a1; variable v1; stmt s1; Select <s1, v1> such "
                       "that Uses(a1,v1) pattern a1 (_,_\"y\"_) ";

        qps.query(query, res);
        REQUIRE(res == expected);
      }

      THEN("For combined query with such that and pattern reversed with 1 "
           "overlapping synonym, the right result is returned") {
        list<string> expected = {"y"};
        list<string> res;

        string query = "assign a1; variable v1; stmt s1; Select v1 pattern a1 "
                       "(_,_\"y\"_) such that Uses(a1,v1)";
      ...
      THEN("For combined query with such that and pattern reversed with 1 "
           "overlapping synonym multiselect, the right result is returned") {
        list<string> expected = {"y 1"};
        list<string> res;

        string query = "assign a1; variable v1; stmt s1; Select <v1, a1> "
                       "pattern a1 (_,_\"y\"_) such that Uses(a1,v1)";
