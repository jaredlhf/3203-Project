...
SCENARIO("Mocking behavior of ModifiesClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When ModifiesClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::MODIFIES, stmtSynArg1, wrongArg2);
      ...
      THEN("When ModifiesClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::MODIFIES, wrongArg1, varSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::MODIFIES, stmtSynArg1, wrongArg2);
        std::shared_ptr<Clause> wrongClause3 =
            Clause::create(Constants::MODIFIES, wcArg1, varSynArg2);
        std::shared_ptr<Clause> wrongClause4 =
            Clause::create(Constants::MODIFIES, wcArg1, constArg2);
        std::shared_ptr<Clause> wrongClause5 =
            Clause::create(Constants::MODIFIES, wcArg1, wcArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(1, _), it should return "
           "the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, constArg1, wcArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(3, _), it should return "
           "no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
      ...
      THEN("When ModifiesClause resolves case Modifies(1, 'z'), it should "
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, constArg1, constArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(1, 'x'), it should "
           "return no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When ModifiesClause resolves case Modifies(1, v2), it should "
           "return the right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, constArg1, varSynArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(3, v2), it should "
           "return no matches") {
      ...
      THEN("When ModifiesClause resolves case Modifies(s1, _), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, stmtSynArg1, wcArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(w1, _), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"w1"});

        std::shared_ptr<Synonym> whSynArg1 =
            Synonym::create(Constants::WHILE, "w1");
        std::shared_ptr<Wildcard> wcArg2 = Wildcard::create();

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, whSynArg1, wcArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(s1, 'z'), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"1"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, stmtSynArg1, constArg2);
      ...
      THEN("When ModifiesClause resolves case Modifies(s1, 'y'), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When ModifiesClause resolves case Modifies(a1, v2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"a1", "v2"});
        expectedTable->addRow({"1", "z"});
        expectedTable->addRow({"2", "x"});

        std::shared_ptr<Synonym> asgSynArg1 =
            Synonym::create(Constants::ASSIGN, "a1");
        std::shared_ptr<Synonym> varSynArg1 =
            Synonym::create(Constants::VARIABLE, "v2");

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, asgSynArg1, varSynArg1);
      ...
      THEN("When ModifiesClause resolves case Modifies(w1, v2), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"w1", "v2"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, whSynArg1, varSynArg1);
      ...
      THEN("When ModifiesClause resolves case Modifies('main', _), it should "
           "return the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
                std::make_pair(Constants::ClauseResult::OK, QpsTable::create());
      ...
      THEN("When ModifiesClause resolves case Modifies('f4', _), it should "
           "return no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When ModifiesClause resolves case Modifies('f3', 'z'), it should "
           "return the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
                std::make_pair(Constants::ClauseResult::OK, QpsTable::create());
      ...
      THEN("When ModifiesClause resolves case Modifies('f3', 'x'), it should "
           "return no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When ModifiesClause resolves case Modifies('f1', v2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"v2"});
      ...
      THEN("When ModifiesClause resolves case Modifies('f4', v2), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"v2"});
      ...
      THEN("When ModifiesClause resolves case Uses(p1, _), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Synonym> procSynArg1 =
            Synonym::create(Constants::PROCEDURE, "p1");
        std::shared_ptr<Wildcard> wcArg2 = Wildcard::create();

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, procSynArg1, wcArg2);
      ...
      THEN("When ModifiesClause resolves case Uses(p1, 'y'), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"p1"});
        expectedTable->addRow({"main"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, procSynArg1, constArg2);
      ...
      THEN("When ModifiesClause resolves case Uses(p1, 'w'), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"p1"});
      ...
      THEN("When ModifiesClause resolves case Uses(p1, v2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"p1", "v2"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::MODIFIES, procSynArg1, varSynArg1);
