...
SCENARIO("Mocking behavior of CallsStClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When CallsStClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Synonym> stmtSynArg2 =
            Synonym::create(Constants::PROCEDURE, "s2");

        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::CALLSST, wrongArg1, stmtSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::CALLSST, stmtSynArg1, wrongArg2);
      ...
      THEN("When CallsStClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
        ...
        std::shared_ptr<Synonym> wrongArg2 =
            Synonym::create(Constants::STMT, "c2");
        std::shared_ptr<Synonym> stmtSynArg1 =
            Synonym::create(Constants::PROCEDURE, "s1");
        std::shared_ptr<Synonym> stmtSynArg2 =
            Synonym::create(Constants::PROCEDURE, "s2");
      ...
      THEN("When CallsStClause resolves case Calls*(_,_), it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, wcArg1, wcArg2);
      ...
      THEN("When CallsStClause resolves case Calls*(_,'f4'), it should return "
           "the right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, wcArg1, constArg2);
      ...
      THEN("When CallsStClause resolves case Calls*(_,'main'), it should "
           "return no matches") {
      ...
      THEN("When CallsStClause resolves case Calls*(_,s2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, wcArg1, synArg2);
      ...
      THEN("When CallsStClause resolves case Calls*('main',_), it should "
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, constArg1, wcArg2);
      ...
      THEN("When CallsStClause resolves case Calls*('f4',_), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When CallsStClause resolves case Calls*('main', 'f3'), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, constArg1, constArg2);
      ...
      THEN("When CallsStClause resolves case Calls*('main','f4'), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When CallsStClause resolves case Calls*('main' ,s2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
        expectedTable->addRow({"factorial"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, constArg1, synArg2);
      ...
      THEN("When CallsStClause resolves case Calls*('f4',s2), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
      ...
      THEN("When CallsStClause resolves case Calls*(s1,_), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, synArg1, wcArg2);
      ...
      THEN("When CallsClause resolves case Calls*(s1,'beta'), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"main"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, synArg1, constArg2);
      ...
      THEN("When CallsStClause resolves case Calls*(s1,'main'), it should "
           "return no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When CallsStClause resolves case Calls*(a1,a2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Synonym> synArg1 =
            Synonym::create(Constants::PROCEDURE, "a1");
        std::shared_ptr<Synonym> synArg2 =
            Synonym::create(Constants::PROCEDURE, "a2");

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::CALLSST, synArg1, synArg2);
      ...
      THEN("When CallsStClause resolves case Calls*(s1,s1), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
