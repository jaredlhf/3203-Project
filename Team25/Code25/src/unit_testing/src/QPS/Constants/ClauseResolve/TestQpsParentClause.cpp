...
SCENARIO("Mocking behavior of ParentClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When ParentClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::PARENT, wrongArg1, stmtSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::PARENT, stmtSynArg1, wrongArg2);
      ...
      THEN("When ParentClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
      ...
      THEN("When ParentClause resolves case Parent(_,_), it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, wcArg1, wcArg2);
      ...
      THEN("When ParentClause resolves case Parent(_,3), it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, wcArg1, constArg2);
      ...
      THEN("When ParentClause resolves case Parent(_,2), it should return no "
           "matches") {
      ...
      THEN("When ParentClause resolves case Parent(_,s2), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, wcArg1, synArg2);
      ...
      THEN("When ParentClause resolves case Parent(_,cll2), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
      ...
      THEN("When ParentClause resolves case Parent(2,_), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, constArg1, wcArg2);
      ...
      THEN("When ParentClause resolves case Parent(1,_), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When ParentClause resolves case Parent(2,3), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, constArg1, constArg2);
      ...
      THEN("When ParentClause resolves case Parent(1,3), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When ParentClause resolves case Parent(2,s2), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
        expectedTable->addRow({"3"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, constArg1, synArg2);
      ...
      THEN("When ParentClause resolves case Parent(1,s2), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
      ...
      THEN("When ParentClause resolves case Parent(s1,_), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, synArg1, wcArg2);
      ...
      THEN("When ParentClause resolves case Parent(a1,_), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
      ...
      THEN("When ParentClause resolves case Parent(s1,3), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"2"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, synArg1, constArg2);
      ...
      THEN("When ParentClause resolves case Parent(s1,1), it should return no "
           "match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When ParentClause resolves case Parent(w1,a2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PARENT, synArg1, synArg2);
      ...
      THEN("When ParentClause resolves case Parent(a1,s2), it should return no "
           "match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When ParentClause resolves case Parent(s1,s1), it should return no "
           "match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
