...
SCENARIO("Mocking behavior of WithClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When WithClause resolves wrong syntax, it should return the right "
           "results") {
        ...
        std::shared_ptr<Synonym> synWithoutAttr =
            Synonym::create(Constants::STMT, "s1");
        std::shared_ptr<Synonym> synWithAttr =
            Synonym::create(Constants::VARIABLE, "v2", Constants::VARNAME);

        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::WITH, wcArg, synWithAttr);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::WITH, synWithAttr, wcArg);
        std::shared_ptr<Clause> wrongClause3 =
            Clause::create(Constants::WITH, synWithoutAttr, synWithAttr);
        std::shared_ptr<Clause> wrongClause4 =
            Clause::create(Constants::WITH, synWithAttr, synWithoutAttr);
        ...
        REQUIRE(wrongClause3->resolve(pkbRet).second->getData() ==
                expectedClauseRes.second->getData());
        REQUIRE(wrongClause4->resolve(pkbRet).first == expectedClauseRes.first);
        REQUIRE(wrongClause4->resolve(pkbRet).second->getData() ==
                expectedClauseRes.second->getData());
      }

      THEN("When WithClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
        ...
        std::shared_ptr<Synonym> intSyn =
            Synonym::create(Constants::ASSIGN, "a2", Constants::STMTNUM);
        std::shared_ptr<Synonym> nonIntSyn =
            Synonym::create(Constants::VARIABLE, "a2", Constants::VARNAME);
        std::shared_ptr<Synonym> mismatchSyn1 =
            Synonym::create(Constants::CONSTANT, "a2", Constants::PROCNAME);
        std::shared_ptr<Synonym> mismatchSyn2 =
            Synonym::create(Constants::PROCEDURE, "a2", Constants::VALUE);

        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::WITH, intArg, nonIntSyn);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::WITH, intSyn, nonIntArg);
        std::shared_ptr<Clause> wrongClause3 =
            Clause::create(Constants::WITH, intArg, nonIntArg);
        std::shared_ptr<Clause> wrongClause4 =
            Clause::create(Constants::WITH, intSyn, nonIntSyn);
        std::shared_ptr<Clause> wrongClause5 =
            Clause::create(Constants::WITH, mismatchSyn1, nonIntSyn);
        std::shared_ptr<Clause> wrongClause6 =
            Clause::create(Constants::WITH, intSyn, mismatchSyn2);
        ...
        REQUIRE(wrongClause5->resolve(pkbRet).second->getData() ==
                expectedClauseRes.second->getData());
        REQUIRE(wrongClause6->resolve(pkbRet).first == expectedClauseRes.first);
        REQUIRE(wrongClause6->resolve(pkbRet).second->getData() ==
                expectedClauseRes.second->getData());
      }

      THEN("When WithClause resolves case with 1 = 1, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::WITH, constArg1, constArg1);
      ...
      THEN("When WithClause resolves case with 1 = 2, it should return no "
           "matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());

        std::shared_ptr<Value> constArg1 = Value::create("1");
        std::shared_ptr<Value> constArg2 = Value::create("2");

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::WITH, constArg1, constArg2);
      ...
      THEN("When WithClause resolves case with 'x' = 'x', it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
                std::make_pair(Constants::ClauseResult::OK, QpsTable::create());
      ...
      THEN("When WithClause resolves case with 'x' = 'xyz', it should return "
           "no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When WithClause resolves case with a.stmt# = 2, it should return "
           "no matches") {
      ...
      THEN("When WithClause resolves case with v.varName = 'x', it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"a.varName", "a"});
        expectedTable->addRow({"x", "x"});

        std::shared_ptr<Synonym> varSynArg1 =
            Synonym::create(Constants::VARIABLE, "a", Constants::VARNAME);
        std::shared_ptr<Value> constArg2 = Value::create("x");
      ...
      THEN("When WithClause resolves case v.varName = 't', it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When WithClause resolves case with 1 = a.stmt#, it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"a.stmt#", "a"});
        ...
        std::shared_ptr<Value> constArg1 = Value::create("1");
        std::shared_ptr<Synonym> varSynArg2 =
            Synonym::create(Constants::ASSIGN, "a", Constants::STMTNUM);

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::WITH, constArg1, varSynArg2);
      ...
      THEN("When WithClause resolves case with 2 = a.stmt#, it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When WithClause resolves case with 'x' = v.varName, it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"a.varName", "a"});
      ...
      THEN("When WithClause resolves case 't' = v.varName, it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When WithClause resolves case w.stmt# = c.value, it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"w", "w.stmt#", "c", "c.value"});
        expectedTable->addRow({"2", "2", "2", "2"});
        expectedTable->addRow({"8", "8", "8", "8"});

        std::shared_ptr<Synonym> stmtSynArg1 =
            Synonym::create(Constants::WHILE, "w", Constants::STMTNUM);
        std::shared_ptr<Synonym> constSynArg2 =
            Synonym::create(Constants::CONSTANT, "c", Constants::VALUE);

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::WITH, stmtSynArg1, constSynArg2);
      ...
      THEN("When WithClause resolves case p.procName = v.varName, it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"p", "p.procName", "v", "v.varName"});
        expectedTable->addRow({"x", "x", "x", "x"});
        expectedTable->addRow({"z", "z", "z", "z"});

        std::shared_ptr<Synonym> synArg1 =
            Synonym::create(Constants::PROCEDURE, "p", Constants::PROCNAME);
        std::shared_ptr<Synonym> synArg2 =
            Synonym::create(Constants::VARIABLE, "v", Constants::VARNAME);

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::WITH, synArg1, synArg2);
