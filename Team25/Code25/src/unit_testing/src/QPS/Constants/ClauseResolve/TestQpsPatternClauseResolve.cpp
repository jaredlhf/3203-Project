...
SCENARIO("Mocking behavior of PatternClause::resolve") {
  GIVEN("An instance of a PkbRetriever class and a target assign synonym") {
    ...
    std::shared_ptr<Synonym> wrongA1 =
        Synonym::create(Constants::VARIABLE, "x1");
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When PatternClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Synonym> wrongSynArg2 =
            Synonym::create(Constants::VARIABLE, "v2");

        std::shared_ptr<Synonym> varSynArg1 =
            Synonym::create(Constants::VARIABLE, "v1");
        std::shared_ptr<Wildcard> wcArg2 = Wildcard::create("1");

        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::PATTERN, wrongArg1, wcArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::PATTERN, varSynArg1, wrongArg2);
        std::shared_ptr<Clause> wrongClause3 =
            Clause::create(Constants::PATTERN, varSynArg1, wrongSynArg2);
        std::shared_ptr<PatternClause> wrongClause1Ptn =
            std::static_pointer_cast<PatternClause>(wrongClause1);
        std::shared_ptr<PatternClause> wrongClause2Ptn =
            std::static_pointer_cast<PatternClause>(wrongClause2);
        std::shared_ptr<PatternClause> wrongClause3Ptn =
            std::static_pointer_cast<PatternClause>(wrongClause3);

        REQUIRE(wrongClause1Ptn->resolve(pkbRet, a1).first ==
                expectedClauseRes.first);
        REQUIRE(wrongClause1Ptn->resolve(pkbRet, a1).second->getData() ==
                expectedClauseRes.second->getData());
        REQUIRE(wrongClause2Ptn->resolve(pkbRet, a1).first ==
                expectedClauseRes.first);
        REQUIRE(wrongClause2Ptn->resolve(pkbRet, a1).second->getData() ==
                expectedClauseRes.second->getData());
        REQUIRE(wrongClause3Ptn->resolve(pkbRet, a1).first ==
                expectedClauseRes.first);
        REQUIRE(wrongClause3Ptn->resolve(pkbRet, a1).second->getData() ==
                expectedClauseRes.second->getData());
      }

      THEN("When PatternClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
        ...
        std::shared_ptr<Synonym> wrongArg1 =
            Synonym::create(Constants::CONSTANT, "v1");
        std::shared_ptr<Synonym> wrongTargetAsg =
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::PATTERN, wrongArg1, wcArg2);
        std::shared_ptr<Clause> validClause2 =
            Clause::create(Constants::PATTERN, varSynArg1, wcArg2);
        std::shared_ptr<PatternClause> wrongClause1Ptn =
            std::static_pointer_cast<PatternClause>(wrongClause1);
        std::shared_ptr<PatternClause> validClause2Ptn =
            std::static_pointer_cast<PatternClause>(validClause2);

        REQUIRE(wrongClause1Ptn->resolve(pkbRet, a1).first ==
                expectedClauseRes.first);
        REQUIRE(wrongClause1Ptn->resolve(pkbRet, a1).second->getData() ==
                expectedClauseRes.second->getData());
        REQUIRE(validClause2Ptn->resolve(pkbRet, wrongTargetAsg).first ==
                expectedClauseRes.first);
        REQUIRE(validClause2Ptn->resolve(pkbRet, wrongTargetAsg)
                    .second->getData() == expectedClauseRes.second->getData());
      }

      THEN("When PatternClause resolves case pattern a1 (_, _), it should "
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PATTERN, wcArg1, wcArg2);
        std::shared_ptr<PatternClause> testClausePtn =
            std::static_pointer_cast<PatternClause>(testClause);

        REQUIRE(testClausePtn->resolve(pkbRet, a1).first == expectedStatus);
        REQUIRE(testClausePtn->resolve(pkbRet, a1).second->getHeaders() ==
                expectedTable->getHeaders());
        REQUIRE(testClausePtn->resolve(pkbRet, a1).second->getData() ==
                expectedTable->getData());
      }

      THEN("When PatternClause resolves case pattern a1 (_, _'y'_), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
      ...
      THEN("When PatternClause resolves case pattern a1 (_, _'x'_), it should "
           "return the right results - multiple lines have x on right hand "
           "side") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
      ...
      THEN("When PatternClause resolves case pattern a1 (_, _'ghi + jkl'_), it "
           "should return the right results - partial op right result") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
        expectedTable->addRow({"5"});
      ...
      THEN("When PatternClause resolves case pattern a1(_, 'z + x'), it should "
           "return the right results - exact pattern matching") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
        expectedTable->addRow({"2"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PATTERN, wcArg1, constArg2);
        std::shared_ptr<PatternClause> testClausePtn =
            std::static_pointer_cast<PatternClause>(testClause);
      ...
      THEN("When PatternClause resolves case pattern a1(_, 'x'), it should "
           "return no matches - exact pattern matching, but only partial "
           "matching case") {
      ...
      THEN("When PatternClause resolves case pattern a1 (_, _'w'_), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When PatternClause resolves case pattern a1 (_, _'w'_) with tab "
           "spaces, it should return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
      ...
      THEN("When PatternClause resolves case pattern a1 ('x', _), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PATTERN, constArg1, wcArg2);
        std::shared_ptr<PatternClause> testClausePtn =
            std::static_pointer_cast<PatternClause>(testClause);
      ...
      THEN("When PatternClause resolves case pattern a1 ('w', _), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When PatternClause resolves case pattern a1 ('x', _'z'_), it "
      ...
      THEN("When PatternClause resolves case pattern a1 ('x', _'w'_), it "
      ...
      THEN("When PatternClause resolves case pattern a1('abc', _'ghi + jkl'_), "
      ...
      THEN("When PatternClause resolves case pattern a1('abc', 'def * (ghi + "
           "jkl + (mnop - 64))'), it should return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName()});
        expectedTable->addRow({"5"});
        ...
        std::shared_ptr<Value> constArg1 = Value::create("abc");
        std::shared_ptr<Value> constArg2 =
            Value::create("def * (ghi + jkl + (mnop - 64))");

        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PATTERN, constArg1, constArg2);
        std::shared_ptr<PatternClause> testClausePtn =
            std::static_pointer_cast<PatternClause>(testClause);
      ...
      THEN("When PatternClause resolves case pattern a1 (v1, _), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName(), "v1"});
      ...
      THEN("When PatternClause resolves case pattern a1 (v1, _'z'_), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName(), "v1"});
      ...
      THEN("When PatternClause resolves case pattern a1 (v1, _'mnop - 64'_), "
           "it should return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName(), "v1"});
      ...
      THEN("When PatternClause resolves case pattern a1 (v1, _'w'_), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
      ...
      THEN("When PatternClause resolves case pattern a1 (v1, 'z + x'), it "
           "should return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({a1->getName(), "v1"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::PATTERN, varSynArg1, constArg2);
        std::shared_ptr<PatternClause> testClausePtn =
            std::static_pointer_cast<PatternClause>(testClause);
