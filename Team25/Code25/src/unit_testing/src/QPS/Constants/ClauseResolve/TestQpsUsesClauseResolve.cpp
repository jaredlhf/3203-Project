...
SCENARIO("Mocking behavior of UsesClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When UsesClause resolves wrong syntax, it should return the right "
           "results") {
        ...
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::USES, stmtSynArg1, wrongArg2);
      ...
      THEN("When UsesClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::USES, wrongArg1, varSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::USES, stmtSynArg1, wrongArg2);
        std::shared_ptr<Clause> wrongClause3 =
            Clause::create(Constants::USES, wcArg1, varSynArg2);
        std::shared_ptr<Clause> wrongClause4 =
            Clause::create(Constants::USES, wcArg1, constArg2);
        std::shared_ptr<Clause> wrongClause5 =
            Clause::create(Constants::USES, wcArg1, wcArg2);
      ...
      THEN("When UsesClause resolves case Uses(1, _), it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, constArg1, wcArg2);
      ...
      THEN("When UsesClause resolves case Uses(4, _), it should return no "
           "matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
      ...
      THEN("When UsesClause resolves case Uses(1, 'x'), it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
                std::make_pair(Constants::ClauseResult::OK, QpsTable::create());
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, constArg1, constArg2);
      ...
      THEN("When UsesClause resolves case Uses(1, 'z'), it should return no "
           "matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When UsesClause resolves case Uses(1, v2), it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, constArg1, varSynArg2);
      ...
      THEN("When UsesClause resolves case Uses(4, v2), it should return no "
           "matches") {
      ...
      THEN("When UsesClause resolves case Uses(s1, _), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, stmtSynArg1, wcArg2);
      ...
      THEN("When UsesClause resolves case Uses(w1, _), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, whSynArg1, wcArg2);
      ...
      THEN("When UsesClause resolves case Uses(s1, 'x'), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"1"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, stmtSynArg1, constArg2);
      ...
      THEN("When UsesClause resolves case Uses(s1, 'w'), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When UsesClause resolves case Uses(a1, v2), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, asgSynArg1, varSynArg1);
      ...
      THEN("When UsesClause resolves case Uses(w1, v2), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, whSynArg1, varSynArg1);
      ...
      THEN("When UsesClause resolves case Modifies('main', _), it should "
      ...
      THEN("When UsesClause resolves case Modifies('f4', _), it should return "
           "no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When UsesClause resolves case Modifies('f3', 'z'), it should "
           "return the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
                std::make_pair(Constants::ClauseResult::OK, QpsTable::create());
      ...
      THEN("When UsesClause resolves case Modifies('f3', 'x'), it should "
           "return no matches") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes = std::make_pair(
                Constants::ClauseResult::NO_MATCH, QpsTable::create());
      ...
      THEN("When UsesClause resolves case Modifies('f1', v2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"v2"});
        expectedTable->addRow({"x"});
      ...
      THEN("When UsesClause resolves case Modifies('f4', v2), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"v2"});
      ...
      THEN("When UsesClause resolves case Uses(p1, _), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, procSynArg1, wcArg2);
      ...
      THEN("When UsesClause resolves case Uses(p1, 'y'), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"p1"});
        expectedTable->addRow({"main"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, procSynArg1, constArg2);
      ...
      THEN("When UsesClause resolves case Uses(p1, 'w'), it should return no "
           "match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"p1"});
      ...
      THEN("When UsesClause resolves case Uses(p1, v2), it should return the "
           "right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::USES, procSynArg1, varSynArg1);
