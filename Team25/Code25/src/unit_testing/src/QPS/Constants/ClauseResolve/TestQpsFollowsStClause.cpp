...
SCENARIO("Mocking behavior of FollowsStClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When FollowsStClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::FOLLOWSST, wrongArg1, stmtSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::FOLLOWSST, stmtSynArg1, wrongArg2);
      ...
      THEN("When FollowsStClause resolves wrong semantics, it should return "
           "the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
      ...
      THEN("When FollowsStClause resolves case FollowsSt(_,_), it should "
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, wcArg1, wcArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(_,8), it should "
           "return the right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, wcArg1, constArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(_,3), it should "
           "return no matches") {
      ...
      THEN("When FollowsStClause resolves case FollowsSt(_,s2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, wcArg1, synArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(_,cll2), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
      ...
      THEN("When FollowsStClause resolves case FollowsSt(1,_), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, constArg1, wcArg2);
      ...
      THEN("When FollowsClause resolves case Follows(2,_), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When FollowsStClause resolves case FollowsSt(3,8), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, constArg1, constArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(1,3), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When FollowsStClause resolves case FollowsSt(3,s2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
        expectedTable->addRow({"4"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, constArg1, synArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(2,s2), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
      ...
      THEN("When FollowsStClause resolves case FollowsSt(s1,_), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, synArg1, wcArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(cll1,_), it should "
           "return no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        ...
        std::shared_ptr<Synonym> synArg1 =
            Synonym::create(Constants::CALL, "cll1");
        std::shared_ptr<Wildcard> wcArg2 = Wildcard::create();
      ...
      THEN("When FollowsClause resolves case Follows(s1,7), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"5"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, synArg1, constArg2);
      ...
      THEN("When FollowsStClause resolves case FollowsSt(s1,3), it should "
           "return no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When FollowsStClause resolves case FollowsSt(a1,s2), it should "
           "return the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWSST, synArg1, synArg2);
      ...
      THEN("When FollowsClause resolves case Follows(if1,a2), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"if1", "a2"});

        std::shared_ptr<Synonym> synArg1 =
            Synonym::create(Constants::IF, "if1");
        std::shared_ptr<Synonym> synArg2 =
