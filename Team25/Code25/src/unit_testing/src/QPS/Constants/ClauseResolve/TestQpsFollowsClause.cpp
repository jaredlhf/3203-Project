...
SCENARIO("Mocking behavior of FollowsClause::resolve") {
  GIVEN("An instance of a PkbRetriever class") {
    ...
    WHEN("PkbRetriever are populated queries that return a non-empty result") {
      ...
      THEN("When FollowsClause resolves wrong syntax, it should return the "
           "right results") {
        ...
        std::shared_ptr<Clause> wrongClause1 =
            Clause::create(Constants::FOLLOWS, wrongArg1, stmtSynArg2);
        std::shared_ptr<Clause> wrongClause2 =
            Clause::create(Constants::FOLLOWS, stmtSynArg1, wrongArg2);
      ...
      THEN("When FollowsClause resolves wrong semantics, it should return the "
           "right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
      ...
      THEN("When FollowsClause resolves case Follows(_,_), it should return "
           "the right results") {
        std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
            expectedClauseRes =
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, wcArg1, wcArg2);
      ...
      THEN("When FollowsClause resolves case Follows(_,2), it should return "
           "the right results") {
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, wcArg1, constArg2);
      ...
      THEN("When FollowsClause resolves case Follows(_,1), it should return no "
           "matches") {
      ...
      THEN("When FollowsClause resolves case Follows(_,s2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, wcArg1, synArg2);
      ...
      THEN("When FollowsClause resolves case Follows(_,cll2), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
      ...
      THEN("When FollowsClause resolves case Follows(1,_), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, constArg1, wcArg2);
      ...
      THEN("When FollowsClause resolves case Follows(16,_), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When FollowsClause resolves case Follows(1,2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, constArg1, constArg2);
      ...
      THEN("When FollowsClause resolves case Follows(1,3), it should return no "
           "matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
      ...
      THEN("When FollowsClause resolves case Follows(2,s2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
        expectedTable->addRow({"13"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, constArg1, synArg2);
      ...
      THEN("When FollowsClause resolves case Follows(16,s2), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s2"});
      ...
      THEN("When FollowsClause resolves case Follows(s1,_), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, synArg1, wcArg2);
      ...
      THEN("When FollowsClause resolves case Follows(rd1,_), it should return "
           "no matches") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        ...
        std::shared_ptr<Synonym> synArg1 =
            Synonym::create(Constants::READ, "rd1");
        std::shared_ptr<Wildcard> wcArg2 = Wildcard::create();
      ...
      THEN("When FollowsClause resolves case Follows(s1,2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
        expectedTable->addRow({"1"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, synArg1, constArg2);
      ...
      THEN("When FollowsClause resolves case Follows(s1,1), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create({"s1"});
      ...
      THEN("When FollowsClause resolves case Follows(a1,a2), it should return "
           "the right results") {
        Constants::ClauseResult expectedStatus = Constants::ClauseResult::OK;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"a1", "a2"});
        ...
        std::shared_ptr<Clause> testClause =
            Clause::create(Constants::FOLLOWS, synArg1, synArg2);
      ...
      THEN("When FollowsClause resolves case Follows(rd1,s2), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable =
            QpsTable::create({"rd1", "s2"});
      ...
      THEN("When FollowsClause resolves case Follows(s1,s1), it should return "
           "no match") {
        Constants::ClauseResult expectedStatus =
            Constants::ClauseResult::NO_MATCH;
        std::shared_ptr<QpsTable> expectedTable = QpsTable::create();
