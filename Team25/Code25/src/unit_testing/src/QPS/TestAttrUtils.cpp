...
TEST_CASE("hasValidAttr returns the right result for procedure keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::PROCEDURE, Constants::PROCNAME) ==
          true);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PROCEDURE, Constants::VARNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PROCEDURE, Constants::VALUE) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PROCEDURE, Constants::STMTNUM) ==
          false);
}

TEST_CASE("hasValidAttr returns the right result for variable keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::VARIABLE, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::VARIABLE, Constants::VARNAME) ==
          true);
  REQUIRE(AttrUtils::hasValidAttr(Constants::VARIABLE, Constants::VALUE) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::VARIABLE, Constants::STMTNUM) ==
          false);
}

TEST_CASE("hasValidAttr returns the right result for constant keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::CONSTANT, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::CONSTANT, Constants::VARNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::CONSTANT, Constants::VALUE) ==
          true);
  REQUIRE(AttrUtils::hasValidAttr(Constants::CONSTANT, Constants::STMTNUM) ==
          false);
}

TEST_CASE("hasValidAttr returns the right result for stmt keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::STMT, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::STMT, Constants::VARNAME) ==
          false);
...
TEST_CASE("hasValidAttr returns the right result for read keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::READ, Constants::PROCNAME) ==
          false);
...
TEST_CASE("hasValidAttr returns the right result for print keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::PRINT, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PRINT, Constants::VARNAME) ==
          true);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PRINT, Constants::VALUE) == false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::PRINT, Constants::STMTNUM) ==
          true);
}

TEST_CASE("hasValidAttr returns the right result for call keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::CALL, Constants::PROCNAME) ==
          true);
  REQUIRE(AttrUtils::hasValidAttr(Constants::CALL, Constants::VARNAME) ==
          false);
...
TEST_CASE("hasValidAttr returns the right result for while keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::WHILE, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::WHILE, Constants::VARNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::WHILE, Constants::VALUE) == false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::WHILE, Constants::STMTNUM) ==
          true);
}
...
TEST_CASE("hasValidAttr returns the right result for assign keyword") {
  REQUIRE(AttrUtils::hasValidAttr(Constants::ASSIGN, Constants::PROCNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::ASSIGN, Constants::VARNAME) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::ASSIGN, Constants::VALUE) ==
          false);
  REQUIRE(AttrUtils::hasValidAttr(Constants::ASSIGN, Constants::STMTNUM) ==
          true);
}
