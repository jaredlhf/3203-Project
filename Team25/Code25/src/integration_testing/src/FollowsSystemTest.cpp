...
SCENARIO("System testing between all components for Follows") {
  GIVEN("The initialization and population of the PKB related classes") {
    ...
    WHEN("The SP and QPS objects are instantiated and a SIMPLE program is "
      ...
      THEN("For selecting statement that follows a statement, the right result "
           "is returned") {
      ...
      THEN("For selecting statement that follows a if statement, the right "
           "result is returned") {
      ...
      THEN("For selecting statement that is within an if statement, the right "
           "result is returned") {
      ...
      THEN("For selecting the last statement within an if statement, the right "
           "result is returned") {
      ...
      THEN("For selecting statement that follows a while statement, the right "
           "result is returned") {
