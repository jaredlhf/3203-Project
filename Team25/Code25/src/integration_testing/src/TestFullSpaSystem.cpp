...
SCENARIO("System testing between all components") {
	GIVEN("The initialization and population of the PKB related classes") {
		...
		PkbPopulator pkbPop(vsPointer, csPointer, fsPointer, psPointer, ssPointer, pattsPointer, fstarsPointer, mprocsPointer, msPointer, pStarsPointer, parentsPointer, uprocsPointer, usesPointer, callsPointer, cstarsPointer, printAttrStorage, readAttrStorage, callAttrStorage, nextPointer, cfgPointer, concallPointer);
		...
		WHEN("The SP and QPS objects are instantiated and a SIMPLE program is defined") {
			...
			THEN("For pattern query in the form (_, 'd'), the right result is returned") {
			...
			THEN("For pattern query in the form (v1, _'y'_), the right result is returned") {
				...
				string query = "assign a1; variable v1; Select v1 pattern a1 (v1, _\"h3\"_)";
			...
			THEN("For pattern query in the form ('x', _'y'_), the right result is returned") {
				...
				string query = "assign Select; variable v1; Select Select pattern Select (\"h\", _\"232141\"_)";
			...
			THEN("For pattern query with var syn in pattern clause, the right result is returned") {
				...
				string query = "assign a1; variable v1; Select a1 pattern a1 (v1, _\"d\"_)";
			...
			THEN("For combined query with 1 overlapping synonym, the right result is returned") {
				...
				string query = "assign a1; variable v1; stmt s1; Select a1 such that Modifies(a1, \"U\") pattern a1(_, _\"d\"_) ";
