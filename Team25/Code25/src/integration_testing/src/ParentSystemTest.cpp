...
SCENARIO("System testing between all components for Parent") {
  GIVEN("The initialization and population of the PKB related classes") {
    ...
    WHEN("The SP and QPS objects are instantiated and a SIMPLE program is "
      ...
      THEN("For selecting a statement within a if container statement, the "
      ...
      THEN("For selecting a statement within a nested if container statement, "
      ...
      THEN("For selecting a statement within a nested while container "
