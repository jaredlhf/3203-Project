...
SCENARIO("System testing between all components for Parent*") {
  GIVEN("The initialization and population of the PKB related classes") {
    ...
    std::shared_ptr<PrintAttribute> printAPointer =
        std::make_shared<PrintAttribute>(printAttr);
    std::shared_ptr<ReadAttribute> readAPointer =
        std::make_shared<ReadAttribute>(readAttr);
    std::shared_ptr<CallAttribute> callAPointer =
        std::make_shared<CallAttribute>(callAttr);
    ...
    WHEN("The SP and QPS objects are instantiated and a SIMPLE program is "
      ...
      THEN("For selecting a statement nested within a if container statement, "
           "the right result is returned") {
      ...
      THEN("For selecting a statement within 2 nested if container statement, "
           "the right result is returned") {
      ...
      THEN("For selecting a statement within 3 nested if container statement, "
           "the right result is returned") {
      ...
      THEN("For selecting a statement within a while container statement, the "
      ...
      THEN("For selecting a statement within 2 nested while container "
           "statement, the right result is returned") {
      ...
      THEN("For selecting a statement within 3 nested while container "
           "statement, the right result is returned") {
      ...
      THEN("For selecting a statement that is the not in a container "
           "statement, the right result is returned") {
