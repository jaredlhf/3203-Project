...
SCENARIO("System testing between all components for Follows*") {
  GIVEN("The initialization and population of the PKB related classes") {
    ...
    WHEN("The SP and QPS objects are instantiated and a SIMPLE program is "
      ...
      THEN("For selecting a if container statement, the right result is "
           "returned") {
      ...
      THEN("For selecting a nested if container statement, the right result is "
           "returned") {
      ...
      THEN("For selecting a while container statement, the right result is "
           "returned") {
      ...
      THEN("For selecting a nested while container statement, the right result "
           "is returned") {
