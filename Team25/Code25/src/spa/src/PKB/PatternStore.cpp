...
int PatternStore::LhsAssignStoreSize() { return LhsAssignStore.size(); }
int PatternStore::RhsAssignStoreSize() { return RhsAssignStore.size(); }

int PatternStore::ifStatementStoreSize() { return ifStatementStore.size(); }
