...
PkbRetriever::PkbRetriever(shared_ptr<VariableStore> varStore,
                           shared_ptr<ConstantStore> constStore,
                           shared_ptr<FollowsStore> followsStore,
                           shared_ptr<ProcedureStore> procedureStore,
                           shared_ptr<StatementStore> statementStore,
                           shared_ptr<PatternStore> patternStore,
                           shared_ptr<FollowsStarStore> followsStarStore,
                           shared_ptr<ModifiesProcStore> modifiesProcStore,
                           shared_ptr<ModifiesStore> modifiesStore,
                           shared_ptr<ParentStarStore> parentStarStore,
                           shared_ptr<ParentStore> parentStore,
                           shared_ptr<UsesProcStore> usesProcStore,
                           shared_ptr<UsesStore> usesStore,
                           shared_ptr<CallsStore> callsStore,
                           shared_ptr<CallsStarStore> callsStarStore,
                           shared_ptr<PrintAttribute> printAttrStore,
                           shared_ptr<ReadAttribute> readAttrStore,
                           shared_ptr<CallAttribute> callAttrStore,
                           shared_ptr<NextStore> nextStore) {
...
PkbRetriever::getUsesPVar(std::string procName) {
  return this->usesProcStorage->getVar(procName);
}

std::unordered_set<std::string>
PkbRetriever::getUsesPProc(std::string varName) {
...
/*Calls Store*/
std::unordered_set<std::string>
PkbRetriever::getLeftCall(std::string rightProc) {
  return this->callsStorage->getLeftProc(rightProc);
}

std::unordered_set<std::string>
PkbRetriever::getRightCall(std::string leftProc) {
...
/*CallsStar Store*/
std::unordered_set<std::string>
PkbRetriever::getLeftCallStar(std::string rightProc) {
  return this->callsStarStorage->getLeftStar(rightProc);
}

std::unordered_set<std::string>
PkbRetriever::getRightCallStar(std::string leftProc) {
