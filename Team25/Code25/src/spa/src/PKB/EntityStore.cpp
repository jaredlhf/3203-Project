...
void ConstantStore::addConst(int constNum) { this->store.emplace(constNum); }

std::unordered_set<int> ConstantStore::getAllConst() { return this->store; }
...
int ConstantStore::size() { return this->store.size(); }

/* Variable Store*/
/*---------------------------------------------------------------------------------------------*/
VariableStore::VariableStore() : store{} {}

VariableStore::VariableStore(std::unordered_set<std::string> store)
    : store{store} {}
...
int VariableStore::size() { return this->store.size(); }

/* Procedure Store*/
/*---------------------------------------------------------------------------------------------*/
ProcedureStore::ProcedureStore() : store{} {}

ProcedureStore::ProcedureStore(std::unordered_set<std::string> store)
    : store{store} {}
...
int ProcedureStore::size() { return this->store.size(); }
...
int StatementStore::size() { return store.size(); }
