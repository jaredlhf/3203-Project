...
bool ParserResponse::compare(ParserResponse other) {
  ...
  std::vector<std::shared_ptr<Synonym>> otherDeclarations =
  ...
  std::vector<std::shared_ptr<Synonym>> otherSynonyms =
      other.getSelectSynonyms();
  // compare synonyms
  ...
  if (!other.getSuchThatClauses().empty() && !this->suchThatClauses.empty()) {
    std::vector<std::shared_ptr<Clause>> otherSuchThatClauses =
        other.getSuchThatClauses();
  ...
  if (!other.getWithClauses().empty() && !this->getWithClauses().empty()) {
    std::vector<std::shared_ptr<Clause>> otherWithClauses =
        other.getWithClauses();
