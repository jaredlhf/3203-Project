...
ParentStrat::ParentStrat(std::string clauseKeyword,
...
std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
ParentStrat::createReturnStrategy() {
