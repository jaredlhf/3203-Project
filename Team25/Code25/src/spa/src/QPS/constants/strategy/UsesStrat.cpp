...
std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
UsesStrat::createReturnStrategy() {
...
UsesStrat::constSyn() {
  std::shared_ptr<Value> v1 = std::static_pointer_cast<Value>(this->arg1);
  const std::string &arg1Val = v1->getVal();
  const std::string &arg2Name =
      std::static_pointer_cast<Synonym>(this->arg2)->getName();
...
// Case: Uses(s1, _)
std::pair<Constants::ClauseResult, std::shared_ptr<QpsTable>>
UsesStrat::synWildcard() {
  std::shared_ptr<Synonym> arg1Syn =
  ...
  if (arg1Syn->matchesKeyword(Constants::PROCEDURE)) {
    ...
    std::unordered_set<int> arg1Stmts =
        arg1Syn->matchesKeyword(Constants::STMT)
...
UsesStrat::synSyn() {
  std::shared_ptr<Synonym> arg1Syn =
      std::static_pointer_cast<Synonym>(this->arg1);
  std::shared_ptr<Synonym> arg2Syn =
