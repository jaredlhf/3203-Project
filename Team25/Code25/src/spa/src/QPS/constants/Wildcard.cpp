...
Wildcard::Wildcard(const std::string &val) { this->val = val; }

// Overriden functions from Entity class
bool Wildcard::isSynonym() { return false; }

bool Wildcard::isConstant() { return false; }
...
const std::string &Wildcard::getVal() const { return this->val; }

bool Wildcard::isGenericWildcard() { return this->val == ""; }
