...
void CFGNode::addLineNo(int lineNo) { lineNo_.push_back(lineNo); }

std::vector<int> CFGNode::getLineNo() const { return lineNo_; }
...
void CFGWhileNode::findLeafNodes(
    std::unordered_set<std::shared_ptr<CFGNode>> &leafNodes) {
