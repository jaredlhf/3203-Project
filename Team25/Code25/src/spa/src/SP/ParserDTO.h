...
class ParserDTO {
public:
  ParserDTO(std::shared_ptr<TNode> tNode, int lineNo)
      : tNode_(tNode), lineNo_(lineNo) {}
  ParserDTO(std::shared_ptr<TNode> tNode, std::shared_ptr<CFGNode> cfgNode)
      : tNode_(tNode), cfgNode_(cfgNode) {}
