...
public:
  ...
  std::string getProc() { return this->name; }
...
public:
  AssignNode(int lineNo, const std::string &variable,
             const std::string &expression, const std::string &proc);
...
public:
  IfNode(int lineNo, const std::string &condExpr,
         std::shared_ptr<StmtLstNode> ifLst,
         std::shared_ptr<StmtLstNode> elseLst, const std::string &proc);
...
public:
  WhileNode(int lineNo, const std::string &condExpr,
            std::shared_ptr<StmtLstNode> stmtLst, const std::string &proc);
  std::string getCondExpr() { return this->condExpr; };
