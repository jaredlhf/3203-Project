...
vector<string> Tokenizer::tokenize(const string &str) {
    ...
    //token delimiters
    const char delimiters_Args[] = {SPConstants::TAB,SPConstants::NEWLINE,SPConstants::SPACE};
    std::vector<char> delimiters(delimiters_Args, std::end(delimiters_Args));
    //single operator and identifier tokens
    const char identifiers_args[] = {SPConstants::RIGHT_BRACE, SPConstants::LEFT_BRACE,SPConstants::RIGHT_BRACKET, SPConstants::LEFT_BRACKET, SPConstants::SEMICOLON,  SPConstants::PLUS, SPConstants::MINUS,SPConstants::TIMES, SPConstants::DIVIDE, SPConstants::MODULO, };
    ...
    const char double_identifiers_args[] = {SPConstants::EQUALS,  SPConstants::MORE_THAN, SPConstants::LESS_THAN, SPConstants::NOT, SPConstants::SINGLE_AND, SPConstants::SINGLE_OR};
    ...
    const char second_operator_args[] = { SPConstants::SINGLE_OR, SPConstants::SINGLE_AND, SPConstants::EQUALS};
